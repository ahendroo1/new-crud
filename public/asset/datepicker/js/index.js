...
DatePicker.defaults = (function( prefix ) {
    ...
    return {
        ...
        // Months and weekdays
        monthsFull: ['Januari', 'Februari', 'Maret', 'April', '05', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember' ],
        monthsShort: [ '01', '02', '03', '04', '05', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec' ],
...
$('.date-input').on('change', function(){
    ...
    var in_booking = $(this).val()
    for (i = 0; i < on_booking.length; i++ ){
        if (on_booking[i] == in_booking) {
            alert('Tanggal Sudah di booking');
            $(this).val('')
            $('.date-button').trigger('click'); 
        }
    }
});